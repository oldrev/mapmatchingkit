...
namespace Sandwych.MapMatchingKit.Tests.Topology.PrecomputedDijkstra
{
    ...
    {
        private static readonly AdjacencyGraph<string, Edge<string>> graph;
        private static readonly Dictionary<Edge<string>, double> edgeCost;

        public static AdjacencyGraph<string, Edge<string>> GraphInstance => graph;
        public static IReadOnlyDictionary<Edge<string>, double> EdgeCosts => edgeCost;
